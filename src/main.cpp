...
int main(int argc, const char * argv[]) {
    ...
    String path = "/Users/davideallegro/Documents/Università/Laurea magistrale/COMPUTER VISION/LAB 6/Lab6_CV/data/video_new.mov";
    // vector of frames
    vector<Mat> frames;
    ...
    String dataset_path = "/Users/davideallegro/Documents/Università/Laurea magistrale/COMPUTER VISION/LAB 6/Lab6_CV/data/objects3/*.png";
    ...
    vector<vector<Point2f>> first_corners;
    first_corners = track.drawRect(H, img_keypoints, tot_corners);
    track.trackObjects(allcoords_keypoints, first_corners);
